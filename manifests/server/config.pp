...
class ssh::server::config (
  ...
  $hostbasedacceptedalgorithms     = undef,
  ...
  $permituserrc                    = undef,
  $persourcemaxstartups            = undef,
  $persourcenetblocksize           = undef,
  $persourcepenalties              = undef,
  $persourcepenaltyexemptlist      = undef,
  $pidfile                         = undef,
  $port                            = '22',
  $printlastlog                    = undef,
  $printmotd                       = undef,
  $pubkeyacceptedalgorithms        = undef,
  $pubkeyauthoptions               = undef,
  $pubkeyauthentication            = undef,
  $rdomain                         = undef,
  $rekeylimit                      = undef,
  $requiredrsasize                 = undef,
  $revokedkeys                     = undef,
  $securitykeyproviders            = undef,
  $setenv                          = undef,
  $sshdsessionpath                 = undef,
